import streamlit as st, pandas as pd, plotly.express as px, pathlib, os
...
# 2) Clustering + iterative reduction
with st.expander("Clustering on 'Other' + Intelligent Labeling (Python-first, LLM optional)", expanded=True):
    ...
    # Intelligent relabeling for all non-rule clusters beginning with "cluster_"
    renamed = {}
